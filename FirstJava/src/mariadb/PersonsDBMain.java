...
public class PersonsDBMain {
	...
	static void update() {
		...
		System.out.print("lastName("+vo.getLastName()+") 수정 : ");
		vo.setLastName(scan.next());
		System.out.print("firstName("+vo.getFirstName()+") 수정 : ");
		vo.setFirstName(scan.next());
		System.out.print("age("+vo.getAge()+") 수정 : ");
		vo.setAge(scan.nextInt());
		System.out.print("city("+vo.getCity()+") 수정 : ");
		vo.setCity(scan.next());
